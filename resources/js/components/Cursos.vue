    ...
    <section>
      ...
      >
        <template v-slot:cell(gestionar)="row">
          <b-button size="sm" class="mr-1" @click="editCurso(row.item)">Editar</b-button>
          <b-button size="sm" class="mr-1 btn btn-danger" @click="deleteCurso(row.item.id)">Borrar</b-button>
        </template>
      </b-table>
      <!-- La Paginación -->
      <b-pagination
      ...
      ></b-pagination>
      <button type="button" @click="nuevo()" class="btn btn-primary btn-block">Afegir Curso</button>
      <!-- Modal Edit  -->
      <b-modal
        id="editCursoModal"
        title="Editar Curso"
      ...
      >
          ...
          <div class="row">
            ...
            <div class="col-7">
              ...
              <select
                ...
                v-model="objectCurso.usuario_username"
              >
                <option :value="null" disabled hidden>Usuaris</option>
                <option
        ...
        <template v-slot:modal-footer>
          ...
          <b-button size="sm" variant="primary" @click="saveCurso(objectCurso.id)">Guardar</b-button>
        </template>
      </b-modal>
      <!-- Modal New  -->
      <b-modal
      ...
      >
          ...
          <div class="row">
            ...
            <div class="col-7">
              ...
              <select
                class="form-control"
                name="usuario_username"
                v-model="nuevoCurso.usuario_username"
              >
                <option :value="null" disabled hidden>Usuaris</option>
                <option
                  v-for="usuari in arrayUsuarios"
        ...
        <template v-slot:modal-footer>
          <b-button size="sm" variant="outline-primary" @click="cancelar()">Cancelar</b-button>
          <!-- Button with custom close trigger value -->
          <b-button size="sm" variant="primary" @click="newCurso(nuevoCurso)">Guardar</b-button>
        </template>
      </b-modal>
    </section>
  </main>
  ...
  data() {
    return {
      ...
      columnasTabla: [
        ...
        { key: "usuario_username", label: "Nombre Usuario" },
        "gestionar"
      ],
      perPage: 5,
      currentPage: 1,
